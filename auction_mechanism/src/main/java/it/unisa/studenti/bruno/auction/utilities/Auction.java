...
public class Auction implements Serializable {
    ...
    public Auction(String _auction_name, User _author, String _description, int _num_products, double _reserved_price, Date _end_time) {
    ...
    public User addBid(double _bid_value, User _bid_owner) {
        ...
        if(_bid_list.size() > _num_products) {
            return (_bid_list.remove(_bid_list.size() - 1))._bid_owner;
        }

        return null;
    }

    // TODO: vedere che metodi servono
    // public ...
